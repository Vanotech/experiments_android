...
import com.vanotech.experiments.core.ui.navigation.BottomSheetSceneStrategy.Companion.bottomSheet
...
class BottomSheetSceneStrategy<T : Any> : SceneStrategy<T> {
    ...
    override fun SceneStrategyScope<T>.calculateScene(entries: List<NavEntry<T>>): Scene<T>? {
        ...
        val bottomSheetProperties = lastEntry.metadata[BottomSheetKey]
